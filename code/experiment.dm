/proc/experiment()
	...
	switch (function)
		if ("item")
			var/select = input("h") as null|anything in list(/obj/item/gun, /obj/item/wrench, /obj/item/pickaxe, /obj/item/sword, /obj/item/beer, /obj/item/injector, /obj/item/rock, /obj/item/wood, /obj/cannon, /obj/respawn_station, /obj/z_entrance, /obj/boombox)
			if (!select)
				return
			new select(usr.loc)
		if ("map gen")
